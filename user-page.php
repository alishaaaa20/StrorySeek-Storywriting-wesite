...
<body>
    ...
    <section class="mission" id="mission">
        ...
        <div class="content">
            ...
            <h3 style="color: black;">It is our mission to remove barriers to build popular web based content as quickly
                & effectively as
                possible</h3>
            <p>The reason Storyseek exist is that we really want the format to scale at a speed like never before.
                Also, since not much is known about the monetization or engagement with Stories on the web, we want
                to provide pillar support to help our users grow in this space. </p>
    ...
    <section class="contact" id="contact">
        ...
        <div class="credit">with love by <span>Aashika and alisha</span> | all rights reserved!</div>
