...
<div id="close-login-btn" class="fas fa-times"></div>
   ...
   <div class="container mt-5" style="margin-top: 13rem!important;">
    ...
    padding: 1rem 3rem; font-family: 'Poppins', sans-serif;">Delete</button>
        ...
        <a href="publish.php" class="btn btn-outline-dark my-3" style="background-color: #219150; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block;
